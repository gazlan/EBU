...
/* ******************************************************************** **
** @@ E_Unpacker_Coin::E_Unpacker_Coin()
** @  Copyrt :
** @  Author :
** @  Modify :
** @  Update :
...
E_Unpacker_Coin::E_Unpacker_Coin(DWORD dwSizeStub,const BYTE* const pBuf,DWORD dwSize,FILE* pFile)
...
void E_Unpacker_Coin::Go(const char* const pszFilename)
{
   ...
   const char*    COIN_PATTERN      = "SO!#";
   const int      COIN_PATTERN_SIZE = 4; 

   QuickSearch((BYTE*)COIN_PATTERN,COIN_PATTERN_SIZE,_pStart,_dwSizeOvr,_pStart,QS_Finder);
}
